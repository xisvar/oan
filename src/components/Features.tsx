      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Verifiable Credentials, <br className="hidden sm:block" />Transparent Matching
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built on cryptographic verification and open standards to restore trust in education.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Every exam result produces a digitally signed record with cryptographic proof of authenticity."
            index={0}
          />
          <FeatureCard
            ...
            description="Public endpoint allows any institution to verify credential signatures and authenticity in real-time."
            index={1}
          />
          <FeatureCard
            ...
            description="Algorithmic matching with ranked preferences and machine-readable criteria replaces arbitrary decisions."
            index={2}
          />
          <FeatureCard
            ...
            title="Audit Log"
            description="Every offer, acceptance, and override is logged as a signed event, visible and searchable."
            index={3}
          />
          <FeatureCard
            ...
            description="Session metadata captures center ID, invigilator ID, and timestamps to verify test authenticity."
            index={4}
          />
          <FeatureCard
            ...
            title="Versioned Corrections"
            description="Document corrections handled through versioned attestations, eliminating physical reprints and office visits."
            index={5}
          />
        </div>
      </div>
