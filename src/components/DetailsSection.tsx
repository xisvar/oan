...
const DetailsSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('send-partner-form', {
        body: {
          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">
            ...
            border: "1px solid #ECECEC"
              ...
              <h3 className="text-lg sm:text-xl font-display mb-6 sm:mb-8">
                Technical specifications without hype
              </h3>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Signatures:</span> ECDSA / RSA
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Storage:</span> Append-only PostgreSQL
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Format:</span> JSON Schema
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Verification:</span> Public API Endpoint
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="p-3 rounded-lg bg-gray-50/80 backdrop-blur-sm border border-gray-100">
                      <span className="font-semibold text-base">Audit:</span> Exportable Human-Readable Logs
                    </div>
                  </div>
                </div>
              </div>
